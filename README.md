...
- Create a POST endpoint to accept the new image, and use Buffer to format the data. Here, we also use a Regular Expression to remove a long "data...;base64," string from the file information.
